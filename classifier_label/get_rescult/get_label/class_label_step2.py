...
def choice_label(label_file, output_file):
    id2label = {}
...
if __name__ == "__main__":
    ...
    output_file = "/data/yuesang/LLM/VectorIE/classifier_label/output/PE-Core-G14-448/conbime/age_output.txt"
    choice_label(label_input_file, output_file)
    
    
    label_input_file = "/data/yuesang/LLM/VectorIE/classifier_label/output/PE-Core-G14-448/normal/gender_output.txt"
    output_file = "/data/yuesang/LLM/VectorIE/classifier_label/output/PE-Core-G14-448/conbime/gender_output.txt"
    choice_label(label_input_file, output_file)