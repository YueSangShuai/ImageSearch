...
class RvT(nn.Module):
    def __init__(self, *, image_size=224, patch_size=16, out_features=512, dim=256, depth=6, heads=8, mlp_dim=128, channel = 3, dim_head = 64, dropout = 0., emb_dropout = 0., use_rotary = True, use_ds_conv = True, use_glu = True):
        super().__init__()
