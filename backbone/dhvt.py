...
class DHVTTiny(VisionTransformer):
    def __init__(self, out_features=256, *kwargs):
        super().__init__(num_classes=out_features, 
            img_size=224, patch_size=16, embed_dim=192, depth=12, num_heads=3, mlp_ratio=4, apply_dhvt=True, *kwargs)
