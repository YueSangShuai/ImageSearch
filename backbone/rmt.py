...
import torch.nn as nn
from .utils import trunc_normal_, DropPath_new as DropPath
...
class Tiny(VisRetNet):
    def __init__(self, out_features=512, **akwargs):
        super().__init__(3, num_classes=out_features, 
