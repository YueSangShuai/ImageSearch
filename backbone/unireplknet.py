...
class UniRepLKNet(nn.Module):
    ...
    def export(self):
        self.reparameterize_unireplknet()
        return self
...
class A(UniRepLKNet):
    def __init__(self, out_features=1000):
        super().__init__(depths=UniRepLKNet_A_F_P_depths, dims=(40, 80, 160, 320), num_classes=out_features)
...
class B(UniRepLKNet):
    def __init__(self, out_features=1000):
        super().__init__(depths=UniRepLKNet_S_B_L_XL_depths, dims=(128, 256, 512, 1024), num_classes=out_features)
...
class L(UniRepLKNet):
    def __init__(self, out_features=1000):
        super().__init__(depths=UniRepLKNet_S_B_L_XL_depths, dims=(192, 384, 768, 1536), num_classes=out_features)
