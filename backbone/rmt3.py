...
from .utils import DropPath_new as DropPath, to_2tuple, trunc_normal_
import torch
...
class DynamicTanh(nn.Module):
    def __init__(self, normalized_shape, shape_dim1=False, alpha_init_value=0.5, eps=1e-6):
        super().__init__()
...
class FeedForwardNetwork(nn.Module):
    def __init__(
        ...
        self.ffn_layernorm = DynamicTanh(ffn_dim, eps=layernorm_eps) if subln else None
...
class RetBlock(nn.Module):
    ...
    def __init__(self, retention: str, embed_dim: int, num_heads: int, ffn_dim: int, drop_path=0., layerscale=False, layer_init_values=1e-5):
        ...
        self.embed_dim = embed_dim
        self.retention_layer_norm = DynamicTanh(self.embed_dim, shape_dim1=True, eps=1e-6)
        ...
        self.final_layer_norm = DynamicTanh(self.embed_dim, shape_dim1=True, eps=1e-6)
...
class PatchMerging(nn.Module):
    ...
    Args:
        ...
        norm_layer (nn.Module, optional): Normalization layer.  Default: DynamicTanh
    """
    def __init__(self, dim, out_dim, norm_layer=DynamicTanh):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, embed_dim, out_dim, depth, num_heads,
                 ...
                 ffn_dim=96., drop_path=0., norm_layer=DynamicTanh, chunkwise_recurrent=False,
...
class LayerNorm2d(nn.Module):
    def __init__(self, dim):
        super().__init__()
        self.norm = DynamicTanh(dim, eps=1e-6)
...
class VisRetNet(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 init_values=[1, 1, 1, 1], heads_ranges=[3, 3, 3, 3], mlp_ratios=[3, 3, 3, 3], drop_path_rate=0.1, norm_layer=DynamicTanh, 
    ...
    def forward(self, x, return_features=False):
        y = self.forward_features(x, return_features=True)
        x = self.head(y[-1])
        y[-1] = x
        if return_features:
            return y
...
class RMT_T3(VisRetNet):
    def __init__(self, out_features):
        super().__init__(in_chans=3, num_classes=out_features, 
