...
class NomicVisionModel(NomicVisionPreTrainedModel):
    ...
    def forward(
        ...
        # age_output=self.age(pooled_output)
        # gender_output=self.gender(pooled_output)
        
        
        return pooled_output
    

class NomicVisionModel_teacher(NomicVisionPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
