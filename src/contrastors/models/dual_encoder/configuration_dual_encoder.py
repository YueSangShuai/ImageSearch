...
class DualEncoderConfig(PretrainedConfig):
    def __init__(
        ...
        **kwargs,
        ...
        if config:
            ...
            self.image_model_args = BiEncoderConfig(**config.vision_model_args.dict(),classifier_config=config.classiffer_config.dict())
            if config.vision_model_args.dict()["distill_type"]!="":
                self.teacher_vision_model_args=BiEncoderConfig(**config.teacher_vision_model_args.dict())
            ...
            self.tower_model_args = None
            self.teacher_vision_model_args=BiEncoderConfig()
    ...
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> PretrainedConfig:
        ...
        for modality in ["text_model_args", "image_model_args", "tower_model_args","teacher_vision_model_args"]:
