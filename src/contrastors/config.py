...
class ClassiferDataArgs(DataArgs):
...
class Config(BaseModel):
    ...
    teacher_vision_model_args: Optional[ModelArgs] = None
    tower_model_args: Optional[ModelArgs] = None
    transforms: Optional[TransformsConfig] = None
    classiffer_config: Optional[ClassiferDataArgs] = None
